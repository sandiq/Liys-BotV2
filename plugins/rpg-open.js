      ...
      case "common":
        switch (jumlah) {
          ...
          case "crate":
            ...
            let cu = _cu * 1;
            let Hcom = `
Anda telah membuka *${rpg.emoticon("common")}Common crate* dan mendapatkan:${cm > 0 ? `\n${rpg.emoticon("money")}money: ${cm}` : ""}${ce > 0 ? `\n${rpg.emoticon("exp")}Exp: ${ce} *exp*` : ""}${cp > 0 ? `\n${rpg.emoticon("potion")}Potion: ${cp} *potion*` : ""}${cc > 0 ? `\n${rpg.emoticon("common")}common crate: ${cc} *crate*` : ""}${cu > 0 ? `\n${rpg.emoticon("uncommon")}Uncommon crate: ${cu} *crate*` : ""}
`.trim();
          ...
          case "10":
            ...
            let cu1 = _cu1 * 1;
            let Hcom1 = `
Anda telah membuka *${rpg.emoticon("common")}Common crate* dan mendapatkan:${cm1 > 0 ? `\n${rpg.emoticon("money")}money: ${cm1}` : ""}${ce1 > 0 ? `\n${rpg.emoticon("exp")}Exp: ${ce1} *exp*` : ""}${cp1 > 0 ? `\n${rpg.emoticon("potion")}Potion: ${cp1} *potion*` : ""}${cc1 > 0 ? `\n${rpg.emoticon("common")}common crate: ${cc1} *crate*` : ""}${cu1 > 0 ? `\n${rpg.emoticon("uncommon")}Uncommon crate: ${cu1} *crate*` : ""}
`.trim();
          ...
          case "100":
            ...
            let cu2 = _cu2 * 1;
            let Hcom2 = `
Anda telah membuka *${rpg.emoticon("common")}Common crate* dan mendapatkan:${cm2 > 0 ? `\n${rpg.emoticon("money")}money: ${cm2}` : ""}${ce2 > 0 ? `\n${rpg.emoticon("exp")}Exp: ${ce2} *exp*` : ""}${cp2 > 0 ? `\n${rpg.emoticon("potion")}Potion: ${cp2} *potion*` : ""}${cc2 > 0 ? `\n${rpg.emoticon("common")}common crate: ${cc2} *crate*` : ""}${cu2 > 0 ? `\n${rpg.emoticon("uncommon")}Uncommon crate: ${cu2} *crate*` : ""}
`.trim();
          ...
          case "1000":
            ...
            let cu3 = _cu3 * 1;
            let Hcom3 = `
Anda telah membuka *${rpg.emoticon("common")}Common crate* dan mendapatkan:${cm3 > 0 ? `\n${rpg.emoticon("money")}money: ${cm3}` : ""}${ce3 > 0 ? `\n${rpg.emoticon("exp")}Exp: ${ce3} *exp*` : ""}${cp3 > 0 ? `\n${rpg.emoticon("potion")}Potion: ${cp3} *potion*` : ""}${cc3 > 0 ? `\n${rpg.emoticon("common")}common crate: ${cc3} *crate*` : ""}${cu3 > 0 ? `\n${rpg.emoticon("uncommon")}Uncommon crate: ${cu3} *crate*` : ""}
`.trim();
      ...
      case "uncommon":
        switch (jumlah) {
          ...
          case "crate":
            ...
            let uc = _uc * 1;
            let Hun = `
Anda telah membuka *${rpg.emoticon("uncommon")}Uncommon crate* dan mendapatkan:${um > 0 ? `\n${rpg.emoticon("money")}money: ${um}` : ""}${ue > 0 ? `\n${rpg.emoticon("exp")}Exp: ${ue} *exp*` : ""}${ud > 0 ? `\n${rpg.emoticon("diamond")}Diamond: ${ud} *diamond*` : ""}${up > 0 ? `\n${rpg.emoticon("potion")}Potion: ${up} *potion*` : ""}${uc > 0 ? `\n${rpg.emoticon("common")}Common crate: ${uc} *crate*` : ""}${uu > 0 ? `\n${rpg.emoticon("uncommon")}Uncommon crate: ${uu} *crate*` : ""}
`.trim();
          ...
          case "10":
            ...
            let uc1 = _uc1 * 1;
            let Hun1 = `
Anda telah membuka *${rpg.emoticon("uncommon")}Uncommon crate* dan mendapatkan:${um1 > 0 ? `\n${rpg.emoticon("money")}money: ${um1}` : ""}${ue1 > 0 ? `\n${rpg.emoticon("exp")}Exp: ${ue1} *exp*` : ""}${ud1 > 0 ? `\n${rpg.emoticon("diamond")}Diamond: ${ud1} *diamond*` : ""}${up1 > 0 ? `\n${rpg.emoticon("potion")}Potion: ${up1} *potion*` : ""}${uc1 > 0 ? `\n${rpg.emoticon("common")}Common crate: ${uc1} *crate*` : ""}${uu1 > 0 ? `\n${rpg.emoticon("uncommon")}Uncommon crate: ${uu1} *crate*` : ""}
`.trim();
            if (global.db.data.users[m.sender].uncommon >= 10) {
              ...
              if (umc1 > 0) {
                m.reply(
                  `*Selamat anda mendapatkan item Rare yaitu*\n${umc1} ${rpg.emoticon("mythic")}Mythic Crate`,
                );
          ...
          case "100":
            ...
            let uc2 = _uc2 * 1;
            let Hun2 = `
Anda telah membuka *${rpg.emoticon("uncommon")}Uncommon crate* dan mendapatkan:${um2 > 0 ? `\n${rpg.emoticon("money")}money: ${um2}` : ""}${ue2 > 0 ? `\n${rpg.emoticon("exp")}Exp: ${ue2} *exp*` : ""}${ud2 > 0 ? `\n${rpg.emoticon("diamond")}Diamond: ${ud2} *diamond*` : ""}${up2 > 0 ? `\n${rpg.emoticon("potion")}Potion: ${up2} *potion*` : ""}${uc2 > 0 ? `\n${rpg.emoticon("common")}Common crate: ${uc2} *crate*` : ""}${uu2 > 0 ? `\n${rpg.emoticon("uncommon")}Uncommon crate: ${uu2} *crate*` : ""}
`.trim();
            if (global.db.data.users[m.sender].uncommon >= 100) {
              ...
              if (umc2 > 0) {
                m.reply(
                  `*Selamat anda mendapatkan item Rare yaitu*\n${umc2} ${rpg.emoticon("mythic")}Mythic Crate`,
                );
          ...
          case "1000":
            ...
            let uc3 = _uc3 * 1;
            let Hun3 = `
Anda telah membuka *${rpg.emoticon("uncommon")}Uncommon crate* dan mendapatkan:${um3 > 0 ? `\n${rpg.emoticon("money")}money: ${um3}` : ""}${ue3 > 0 ? `\n${rpg.emoticon("exp")}Exp: ${ue3} *exp*` : ""}${ud3 > 0 ? `\n${rpg.emoticon("diamond")}Diamond: ${ud3} *diamond*` : ""}${up3 > 0 ? `\n${rpg.emoticon("potion")}Potion: ${up3} *potion*` : ""}${uc3 > 0 ? `\n${rpg.emoticon("common")}Common crate: ${uc3} *crate*` : ""}${uu3 > 0 ? `\n${rpg.emoticon("uncommon")}Uncommon crate: ${uu3} *crate*` : ""}
`.trim();
            if (global.db.data.users[m.sender].uncommon >= 1000) {
              ...
              if (umc3 > 0) {
                m.reply(
                  `*Selamat anda mendapatkan item Rare yaitu*\n${umc3} ${rpg.emoticon("mythic")}Mythic Crate`,
                );
      ...
      case "mythic":
        switch (jumlah) {
          ...
          case "crate":
            ...
            let md = _md * 1;
            let Mychat = `
Anda telah membuka *${rpg.emoticon("mythic")}Mythic crate* dan mendapatkan:${mm > 0 ? `\n${rpg.emoticon("money")}money: ${mm}` : ""}${me > 0 ? `\n${rpg.emoticon("exp")}Exp: ${me} *exp*` : ""}${md > 0 ? `\n${rpg.emoticon("diamond")}Diamond: ${md} *diamond*` : ""}${mp > 0 ? `\n${rpg.emoticon("potion")}Potion: ${mp} *potion*` : ""}${mc > 0 ? `\n${rpg.emoticon("common")}Common crate: ${mc} *crate*` : ""}${mu > 0 ? `\n${rpg.emoticon("uncommon")}Uncommon crate: ${mu} *crate*` : ""}
`.trim();
          ...
          case "10":
            ...
            let md1 = _md1 * 1;
            let Mychat1 = `
Anda telah membuka *${rpg.emoticon("mythic")}Mythic crate* dan mendapatkan:${mm1 > 0 ? `\n${rpg.emoticon("money")}money: ${mm1}` : ""}${me1 > 0 ? `\n${rpg.emoticon("exp")}Exp: ${me1} *exp*` : ""}${md1 > 0 ? `\n${rpg.emoticon("diamond")}Diamond: ${md1} *diamond*` : ""}${mp1 > 0 ? `\n${rpg.emoticon("potion")}Potion: ${mp1} *potion*` : ""}${mc1 > 0 ? `\n${rpg.emoticon("common")}Common crate: ${mc1} *crate*` : ""}${mu1 > 0 ? `\n${rpg.emoticon("uncommon")}Uncommon crate: ${mu1} *crate*` : ""}
`.trim();
            if (global.db.data.users[m.sender].mythic >= 10) {
              ...
              if (mmm1 > 0) {
                m.reply(
                  `*Selamat anda mendapatkan item Rare yaitu*\n${mmm1} ${rpg.emoticon("mythic")}Mythic Crate`,
                );
                global.db.data.users[m.sender].mythic += mmm1 * 1;
              }
              if (ml1 > 0) {
                m.reply(
                  `*Selamat anda mendapatkan item Epic yaitu*\n${ml1} ${rpg.emoticon("legendary")}Legendary Crate`,
                );
                global.db.data.users[m.sender].legendary += ml1 * 1;
              }
            } else conn.reply(m.chat, rpg.emoticon("mythic") + "Mythic crate anda tidak cukup", m);
            break;
          case "100":
            ...
            let md2 = _md2 * 1;
            let Mychat2 = `
Anda telah membuka *${rpg.emoticon("mythic")}Mythic crate* dan mendapatkan:${mm2 > 0 ? `\n${rpg.emoticon("money")}money: ${mm2}` : ""}${me2 > 0 ? `\n${rpg.emoticon("exp")}Exp: ${me2} *exp*` : ""}${md2 > 0 ? `\n${rpg.emoticon("diamond")}Diamond: ${md2} *diamond*` : ""}${mp2 > 0 ? `\n${rpg.emoticon("potion")}Potion: ${mp2} *potion*` : ""}${mc2 > 0 ? `\n${rpg.emoticon("common")}Common crate: ${mc2} *crate*` : ""}${mu2 > 0 ? `\n${rpg.emoticon("uncommon")}Uncommon crate: ${mu2} *crate*` : ""}
`.trim();
          ...
          case "1000":
            ...
            let md3 = _md3 * 1;
            let Mychat3 = `
Anda telah membuka *${rpg.emoticon("mythic")}Mythic crate* dan mendapatkan:${mm3 > 0 ? `\n${rpg.emoticon("money")}money: ${mm3}` : ""}${me3 > 0 ? `\n${rpg.emoticon("exp")}Exp: ${me3} *exp*` : ""}${md3 > 0 ? `\n${rpg.emoticon("diamond")}Diamond: ${md3} *diamond*` : ""}${mp3 > 0 ? `\n${rpg.emoticon("potion")}Potion: ${mp3} *potion*` : ""}${mc3 > 0 ? `\n${rpg.emoticon("common")}Common crate: ${mc3} *crate*` : ""}${mu3 > 0 ? `\n${rpg.emoticon("uncommon")}Uncommon crate: ${mu3} *crate*` : ""}
`.trim();
            if (global.db.data.users[m.sender].mythic >= 1000) {
              ...
              if (mmm3 > 0) {
                m.reply(
                  `*Selamat anda mendapatkan item Rare yaitu*\n${mmm3} ${rpg.emoticon("mythic")}Mythic Crate`,
                );
                global.db.data.users[m.sender].mythic += mmm3 * 1;
              }
              if (ml3 > 0) {
                m.reply(
                  `*Selamat anda mendapatkan item Epic yaitu*\n${ml3} ${rpg.emoticon("legendary")}Legendary Crate`,
                );
      ...
      case "legendary":
        switch (jumlah) {
          ...
          case "crate":
            ...
            let lmm = _lmm * 1;
            let Lechat = `
Anda telah membuka *${rpg.emoticon("legendary")}Legendary crate* dan mendapatkan:${lm > 0 ? `\n${rpg.emoticon("money")}money: ${lm}` : ""}${le > 0 ? `\n${rpg.emoticon("exp")}Exp: ${le} *exp*` : ""}${ld > 0 ? `\n${rpg.emoticon("diamond")}Diamond: ${ld} *diamond*` : ""}${lp > 0 ? `\n${rpg.emoticon("potion")}Potion: ${lp} *potion*` : ""}${lc > 0 ? `\n${rpg.emoticon("common")}Common crate: ${lc} *crate*` : ""}${lu > 0 ? `\n${rpg.emoticon("uncommon")}Uncommon crate: ${lu} *crate*` : ""}
`.trim();
            if (global.db.data.users[m.sender].legendary >= 1) {
              ...
              if (lmm > 0) {
                m.reply(
                  `*Selamat anda mendapatkan item Rare yaitu*\n${lmm} ${rpg.emoticon("mythic")}Mythic Crate`,
                );
                global.db.data.users[m.sender].mythic += lmm * 1;
              }
              if (ll > 0 || lpp > 0) {
                m.reply(
                  `*Selamat anda mendapatkan item Epic yaitu*${ll > 0 ? `\n${ll} ${rpg.emoticon("legendary")}Legendary Crate` : ""}${lpp > 0 ? `\n${lpp} ${rpg.emoticon("pet")}Pet Crate` : ""}`,
                );
                global.db.data.users[m.sender].legendary += ll * 1;
                global.db.data.users[m.sender].pet += lpp * 1;
              }
            } else conn.reply(m.chat, rpg.emoticon("money")+"Legendary crate anda tidak cukup", m);
            break;
          case "10":
            ...
            let lmm1 = _lmm1 * 1;
            let Lechat1 = `
Anda telah membuka *${rpg.emoticon("legendary")}Legendary crate* dan mendapatkan:${lm1 > 0 ? `\n${rpg.emoticon("money")}money: ${lm1}` : ""}${le1 > 0 ? `\n${rpg.emoticon("exp")}Exp: ${le1} *exp*` : ""}${ld1 > 0 ? `\n${rpg.emoticon("diamond")}Diamond: ${ld1} *diamond*` : ""}${lp1 > 0 ? `\n${rpg.emoticon("potion")}Potion: ${lp1} *potion*` : ""}${lc1 > 0 ? `\n${rpg.emoticon("common")}Common crate: ${lc1} *crate*` : ""}${lu1 > 0 ? `\n${rpg.emoticon("uncommon")}Uncommon crate: ${lu1} *crate*` : ""}
`.trim();
            if (global.db.data.users[m.sender].legendary >= 10) {
              ...
              if (lmm1 > 0) {
                m.reply(
                  `*Selamat anda mendapatkan item Rare yaitu*\n${lmm1} ${rpg.emoticon("mythic")}Mythic Crate`,
                );
                global.db.data.users[m.sender].mythic += lmm1 * 1;
              }
              if (ll1 > 0 || lpp1 > 0) {
                m.reply(
                  `*Selamat anda mendapatkan item Epic yaitu*${ll1 > 0 ? `\n${ll1} ${rpg.emoticon("legendary")}Legendary Crate` : ""}${lpp1 > 0 ? `\n${lpp1} ${rpg.emoticon("pet")}Pet Crate` : ""}`,
                );
          ...
          case "100":
            ...
            let lmm2 = _lmm2 * 1;
            let Lechat2 = `
Anda telah membuka *${rpg.emoticon("legendary")}Legendary crate* dan mendapatkan:${lm2 > 0 ? `\n${rpg.emoticon("money")}money: ${lm2}` : ""}${le2 > 0 ? `\n${rpg.emoticon("exp")}Exp: ${le2} *exp*` : ""}${ld2 > 0 ? `\n${rpg.emoticon("diamond")}Diamond: ${ld2} *diamond*` : ""}${lp2 > 0 ? `\n${rpg.emoticon("potion")}Potion: ${lp2} *potion*` : ""}${lc2 > 0 ? `\n${rpg.emoticon("common")}Common crate: ${lc2} *crate*` : ""}${lu2 > 0 ? `\n${rpg.emoticon("uncommon")}Uncommon crate: ${lu2} *crate*` : ""}
`.trim();
            if (global.db.data.users[m.sender].legendary >= 100) {
              ...
              if (lmm2 > 0) {
                m.reply(
                  `*Selamat anda mendapatkan item Rare yaitu*\n${lmm2} ${rpg.emoticon("mythic")}Mythic Crate`,
                );
                global.db.data.users[m.sender].mythic += lmm2 * 1;
              }
              if (ll2 > 0 || lpp2 > 0) {
                m.reply(
                  `*Selamat anda mendapatkan item Epic yaitu*${ll2 > 0 ? `\n${ll2} ${rpg.emoticon("legendary")}Legendary Crate` : ""}${lpp2 > 0 ? `\n${lpp2} ${rpg.emoticon("pet")}Pet Crate` : ""}`,
                );
          ...
          case "1000":
            ...
            let lmm3 = _lmm3 * 1;
            let Lechat3 = `
Anda telah membuka *${rpg.emoticon("legendary")}Legendary crate* dan mendapatkan:${lm3 > 0 ? `\n${rpg.emoticon("money")}money: ${lm3}` : ""}${le3 > 0 ? `\n${rpg.emoticon("exp")}Exp: ${le3} *exp*` : ""}${ld3 > 0 ? `\n${rpg.emoticon("diamond")}Diamond: ${ld3} *diamond*` : ""}${lp3 > 0 ? `\n${rpg.emoticon("potion")}Potion: ${lp3} *potion*` : ""}${lc3 > 0 ? `\n${rpg.emoticon("common")}Common crate: ${lc3} *crate*` : ""}${lu3 > 0 ? `\n${rpg.emoticon("uncommon")}Uncommon crate: ${lu3} *crate*` : ""}
`.trim();
            if (global.db.data.users[m.sender].legendary >= 1000) {
              ...
              if (lmm3 > 0) {
                m.reply(
                  `*Selamat anda mendapatkan item Rare yaitu*\n${lmm3} ${rpg.emoticon("mythic")}Mythic Crate`,
                );
                global.db.data.users[m.sender].mythic += lmm3 * 1;
              }
              if (ll3 > 0 || lpp3 > 0) {
                m.reply(
                  `*Selamat anda mendapatkan item Epic yaitu*${ll3 > 0 ? `\n${ll3} ${rpg.emoticon("legendary")}Legendary Crate` : ""}${lpp3 > 0 ? `\n${lpp3} ${rpg.emoticon("pet")}Pet Crate` : ""}`,
                );
      ...
      case "pet":
        ...
        let _pet =
          `${pickRandom(["kucing", "rubah", "anjing", "kuda"])}`.trim();
        if (global.db.data.users[m.sender].pet > 0) {
          ...
          if (_pet == "kucing" && kucing > 0) {
            ...
            conn.reply(
              m.chat,
              `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion${mknp > 0 ? ` Dan ${mknp} ${rpg.emoticon("petfood")}Makanan Pet` : ""}`,
              m,
            );
            ...
            conn.reply(
              m.chat,
              `*Selamat Anda mendapatkan pet${_pet} ${mknp > 0 ? ` Dan ${mknp} ${rpg.emoticon("petfood")}Makanan Pet*` : "*"}`,
              m,
            );
        ...
        } else m.reply(rpg.emoticon("pet")+"Pet Crate kamu tidak cukup");
        break;
      default:
...
handler.help = ["open", "gacha"].map((v) => v + " (Ⓕ)");
handler.tags = ["rpg"];
handler.command = ["open", "gacha"];
