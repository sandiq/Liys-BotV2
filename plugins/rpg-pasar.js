          ...
          switch (_type) {
            case "banteng":
              if (global.db.data.users[m.sender].banteng >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Banteng Dengan Harga ${Sbanteng * count} Money `.trim(),
                  m,
                );
            ...
            case "harimau":
              if (global.db.data.users[m.sender].harimau >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Harimau Dengan Harga ${Sharimau * count} Money `.trim(),
                  m,
                );
            ...
            case "gajah":
              if (global.db.data.users[m.sender].gajah >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Gajah Dengan Harga ${Sgajah * count} Money `.trim(),
                  m,
                );
            ...
            case "kambing":
              if (global.db.data.users[m.sender].kambing >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Kambing Dengan Harga ${Skambing * count} Money `.trim(),
                  m,
                );
            ...
            case "panda":
              if (global.db.data.users[m.sender].panda >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Panda Dengan Harga ${Sbuaya * count} Money `.trim(),
                  m,
                );
            ...
            case "buaya":
              if (global.db.data.users[m.sender].buaya >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Buaya Dengan Harga ${Sbuaya * count} Money `.trim(),
                  m,
                );
            ...
            case "kerbau":
              if (global.db.data.users[m.sender].kerbau >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Kerbau Dengan Harga ${Skerbau * count} Money `.trim(),
                  m,
                );
            ...
            case "sapi":
              if (global.db.data.users[m.sender].sapi >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Sapi Dengan Harga ${Ssapi * count} Money `.trim(),
                  m,
                );
            ...
            case "monyet":
              if (global.db.data.users[m.sender].monyet >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Monyet Dengan Harga ${Smonyet * count} Money `.trim(),
                  m,
                );
            ...
            case "babi":
              if (global.db.data.users[m.sender].babi >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Babi Dengan Harga ${Sbabi * count} Money `.trim(),
                  m,
                );
            ...
            case "babihutan":
              if (global.db.data.users[m.sender].babihutan >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Babi Hutan Dengan Harga ${Sbabihutan * count} Money `.trim(),
                  m,
                );
              } else
            ...
            case "ayam":
              if (global.db.data.users[m.sender].ayam >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Ayam Dengan Harga ${Sayam * count} Money `.trim(),
                  m,
                );
            ...
            case "kepiting":
              if (global.db.data.users[m.sender].kepiting >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Kepiting Dengan Harga ${Skepiting * count} Money `.trim(),
                  m,
                );
            ...
            case "ikan":
              if (global.db.data.users[m.sender].ikan >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Ikan Dengan Harga ${Sikan * count} Money `.trim(),
                  m,
                );
            ...
            case "dory":
              if (global.db.data.users[m.sender].dory >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Ikan Dory Dengan Harga ${Sdory * count} Money `.trim(),
                  m,
                );
            ...
            case "gurita":
              if (global.db.data.users[m.sender].gurita >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Gurita Dengan Harga ${Sgurita * count} Money `.trim(),
                  m,
                );
            ...
            case "buntal":
              if (global.db.data.users[m.sender].buntal >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Ikan Buntal Dengan Harga ${Sbuntal * count} Money `.trim(),
                  m,
                );
              } else
            ...
            case "hiu":
              if (global.db.data.users[m.sender].hiu >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Hiu Dengan Harga ${Shiu * count} Money `.trim(),
                  m,
                );
            ...
            case "orca":
              if (global.db.data.users[m.sender].orca >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Paus Orca Dengan Harga ${Sorca * count} Money `.trim(),
                  m,
                );
            ...
            case "lumba":
              if (global.db.data.users[m.sender].lumba >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Lumba Lumba Dengan Harga ${Slumba * count} Money `.trim(),
                  m,
                );
              } else
            ...
            case "paus":
              if (global.db.data.users[m.sender].paus >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Paus Dengan Harga ${Spaus * count} Money `.trim(),
                  m,
                );
            ...
            case "lobster":
              if (global.db.data.users[m.sender].lobster >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Lobster Dengan Harga ${Slobster * count} Money `.trim(),
                  m,
                );
            ...
            case "udang":
              if (global.db.data.users[m.sender].udang >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Udang Dengan Harga ${Sudang * count} Money `.trim(),
                  m,
                );
            ...
            case "cumi":
              if (global.db.data.users[m.sender].cumi >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Menjual ${count} Cumi Dengan Harga ${Scumi * count} Money `.trim(),
                  m,
                );
...
handler.help = ["pasar"].map((v) => v + " (Ⓕ)");
handler.tags = ["rpg"];
handler.command = ["pasar"];
