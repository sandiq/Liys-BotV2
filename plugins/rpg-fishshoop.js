...
let handler = async (m, { conn, command, args, usedPrefix, DevMode }) => {
  if (!db.data.chats[m.chat].rpg && m.isGroup)
    throw "Feature Rpg Dimatikan Di grup ini\nKetik *!on* *rpg* untuk mengaktifkan fitur";
          ...
          switch (_type) {
            case "paus":
              if (global.db.data.users[m.sender].money >= Bpaus * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} paus dengan harga ${Bpaus * count} money\n\n`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} paus dengan harga ${paus * count} money`,
                );
              break;
            case "ikan":
              if (global.db.data.users[m.sender].money >= Bikan * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} ikan dengan harga ${Bikan * count} money`,
                  m,
                );
            ...
            case "cumi":
              if (global.db.data.users[m.sender].money >= Bcumi * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} cumi  dengan harga ${Bcumi * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} cumi dengan harga ${Bcumi * count} money\n\n*`,
                  m,
                );
            ...
            case "kepiting":
              if (global.db.data.users[m.sender].money >= Bkepiting * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} kepiting  dengan harga ${Bkepiting * count} money`,
                  m,
                );
              } else
                conn.reply(
            ...
            case "udang":
              if (global.db.data.users[m.sender].money >= Budang * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} udang  dengan harga ${Budang * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} udang  dengan harga ${Budang * count} money\n\n*`,
                  m,
                );
            ...
            case "dory":
              if (global.db.data.users[m.sender].money >= Bdory * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} dory  dengan harga ${Bdory * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} dory  dengan harga ${Bdory * count} money\n\n*`,
                  m,
                );
            ...
            case "lobster":
              if (global.db.data.users[m.sender].money >= Blobster * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} dory  dengan harga ${Blobster * count} money`,
                  m,
                );
              } else
                conn.reply(
            ...
            case "buntal":
              if (global.db.data.users[m.sender].money >= Bbuntal * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} buntal  dengan harga ${Bbuntal * count} money`,
                  m,
                );
              } else
                conn.reply(
            ...
            case "orca":
              if (global.db.data.users[m.sender].money >= Borca * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli  orca dengan harga ${Borca * count} money\n\n`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} orca dengan hargBo) * count} money\n\n`,
                  m,
                );
              break;
            case "gurita":
              if (global.db.data.users[m.sender].money >= Bgurita * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} gurita dengan harga ${Bgurita * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} gurita dengan harga ${Bgurita * count} money`.trim(),
                  m,
                );
              break;
          }
          ...
          switch (_type) {
            case "orca":
              if (global.db.data.users[m.sender].orca >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} orca dengan harga ${Sorca * count} money`.trim(),
                  m,
                );
            ...
            case "ikan":
              if (global.db.data.users[m.sender].ikan >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} ikan  dengan harga ${Sikan * count} money`.trim(),
                  m,
                );
            ...
            case "paus":
              if (global.db.data.users[m.sender].paus >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} paus  dengan harga ${Spaus * count} money`.trim(),
                  m,
                );
            ...
            case "gurita":
              if (global.db.data.users[m.sender].gurita >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} gurita  dengan harga ${Sgurita * count} money`.trim(),
                  m,
                );
            ...
            case "udang":
              if (global.db.data.users[m.sender].udang >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} udang  dengan harga ${Sudang * count} money`.trim(),
                  m,
                );
            ...
            case "buntal":
              if (global.db.data.users[m.sender].buntal >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} buntal, dan anda mendapatkan ${Sbuntal * count} money`,
                  m,
                );
            ...
            case "lobster":
              if (global.db.data.users[m.sender].lobster >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} lobster, dan anda mendapatkan ${Slobster * count} money`,
                  m,
                );
            ...
            case "dory":
              if (global.db.data.users[m.sender].dory >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} dory, dan anda mendapatkan ${Sdory * count} money`,
                  m,
                );
            ...
            case "cumi":
              if (global.db.data.users[m.sender].cumi >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} cumi, dan anda mendapatkan ${Scumi * count} money`,
                  m,
                );
            ...
            case "kepiting":
              if (global.db.data.users[m.sender].kepiting >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} kepiting, dan anda mendapatkan ${Skepiting * count} money`,
                  m,
                );
            ...
            case "hiu":
              if (global.db.data.users[m.sender].hiu >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} hiu, dan anda mendapatkan ${Shiu * count} money`,
                  m,
                );
            ...
            case "lumba":
              if (global.db.data.users[m.sender].lumba >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} lumba, dan anda mendapatkan ${Slumba * count} money`,
                  m,
                );
...
handler.help = ["fishop", "tokoikan"].map((v) => v + " (Ⓕ)");
handler.tags = ["rpg"];

handler.command = ["tokoikan", "fishshop"];
