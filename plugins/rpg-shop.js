          ...
          switch (_type) {
            ...
            case "diamond":
              if (global.db.data.users[m.sender].money >= Bdiamond * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Diamond dengan harga ${Bdiamond * count} money`,
                  m,
                );
            ...
            case "common":
              if (global.db.data.users[m.sender].money >= Bcommon * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Common crate dengan harga ${Bcommon * count} money`,
                  m,
                );
              } else
                conn.reply(
            ...
            case "uncommon":
              if (global.db.data.users[m.sender].money >= Buncommon * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Uncommon crate dengan harga ${Buncommon * count} money`,
                  m,
                );
              } else
                conn.reply(
            ...
            case "mythic":
              if (global.db.data.users[m.sender].money >= Bmythic * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Mythic crate dengan harga ${Bmythic * count} money`,
                  m,
                );
              } else
                conn.reply(
            ...
            case "legendary":
              if (global.db.data.users[m.sender].money >= Blegendary * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Legendary crate dengan harga ${Blegendary * count} money`,
                  m,
                );
              } else
                conn.reply(
            ...
            case "sampah":
              if (global.db.data.users[m.sender].money >= Bsampah * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Sampah dengan harga ${Bsampah * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} Sampah dengan harga ${Bsampah * count} money`.trim(),
                  m,
                );
            ...
            case "kaleng":
              if (global.db.data.users[m.sender].money >= Bkaleng * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Kaleng dengan harga ${Bkaleng * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} Kaleng dengan harga ${Bkaleng * count} money`.trim(),
                  m,
                );
            ...
            case "kardus":
              if (global.db.data.users[m.sender].money >= Bkardus * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Kardus dengan harga ${Bkardus * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} Kardus dengan harga ${Bkardus * count} money`.trim(),
                  m,
                );
            ...
            case "botol":
              if (global.db.data.users[m.sender].money >= Bbotol * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Botol dengan harga ${Bbotol * count} money`,
                  m,
                );
              } else
                conn.reply(
            ...
            case "kayu":
              if (global.db.data.users[m.sender].money >= Bkayu * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Kayu dengan harga ${Bkayu * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} kayu dengan harga ${Bkayu * count} money`.trim(),
                  m,
                );
            ...
            case "pisang":
              if (global.db.data.users[m.sender].money >= Bpisang * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Pisang dengan harga ${Bpisang * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} pisang dengan harga ${Bpisang * count} money`.trim(),
                  m,
                );
            ...
            case "anggur":
              if (global.db.data.users[m.sender].money >= Banggur * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Anggur dengan harga ${Banggur * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} anggur dengan harga ${Banggur * count} money`.trim(),
                  m,
                );
            ...
            case "mangga":
              if (global.db.data.users[m.sender].money >= Bmangga * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Mangga dengan harga ${Bmangga * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} mangga dengan harga ${Bmangga * count} money`.trim(),
                  m,
                );
            ...
            case "jeruk":
              if (global.db.data.users[m.sender].money >= Bjeruk * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Jeruk dengan harga ${Bjeruk * count} money`,
                  m,
                );
              } else
                conn.reply(
            ...
            case "apel":
              if (global.db.data.users[m.sender].money >= Bapel * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Apel dengan harga ${Bapel * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} apel dengan harga ${Bapel * count} money`.trim(),
                  m,
                );
            ...
            case "bibitpisang":
              if (
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Bibit Pisang dengan harga ${Bbibitpisang * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} bibit pisang dengan harga ${Bbibitpisang * count} money`.trim(),
                  m,
                );
            ...
            case "bibitanggur":
              if (
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Bibit Anggur dengan harga ${Bbibitanggur * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} bibit anggur dengan harga ${Bbibitanggur * count} money`.trim(),
                  m,
                );
            ...
            case "bibitmangga":
              if (
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Bibit Mangga dengan harga ${Bbibitmangga * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} bibit mangga dengan harga ${Bbibitmangga * count} money`.trim(),
                  m,
                );
            ...
            case "bibitjeruk":
              if (global.db.data.users[m.sender].money >= Bbibitjeruk * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Bibit Jeruk dengan harga ${Bbibitjeruk * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} bibit jeruk dengan harga ${Bbibitjeruk * count} money`.trim(),
                  m,
                );
            ...
            case "bibitapel":
              if (global.db.data.users[m.sender].money >= Bbibitapel * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Bibit Apel dengan harga ${Bbibitapel * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} bibit apel dengan harga ${Bbibitapel * count} money`.trim(),
                  m,
                );
            ...
            case "gardenboxs":
              if (global.db.data.users[m.sender].money >= Bgardenboxs * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Gardenboxs dengan harga ${Bgardenboxs * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} gardenboxs dengan harga ${Bgardenboxs * count} money`.trim(),
                  m,
                );
            ...
            case "berlian":
              if (global.db.data.users[m.sender].money >= Bberlian * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Berlian dengan harga ${Bberlian * count} money`,
                  m,
                );
              } else
                conn.reply(
            ...
            case "bensin":
              if (global.db.data.users[m.sender].money >= BBensin * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count}L Bensin dengan harga ${BBensin * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} Bensin dengan harga ${BBensin * count} money`.trim(),
                  m,
                );
            ...
            case "weapon":
              if (global.db.data.users[m.sender].money >= BWeap * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Weapon dengan harga ${BWeap * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} Weapon dengan harga ${BWeap * count} money`.trim(),
                  m,
                );
            ...
            case "obat":
              if (global.db.data.users[m.sender].money >= BObat * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} kapsul Obat dengan harga ${BObat * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} kapsul Obat dengan harga ${BObat * count} money`.trim(),
                  m,
                );
            ...
            case "emas":
              if (global.db.data.users[m.sender].money >= Bemasbiasa * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Emas dengan harga ${Bemasbiasa * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} emas dengan harga ${Bemasbiasa * count} money`.trim(),
                  m,
                );
            ...
            case "pet":
              if (global.db.data.users[m.sender].money >= Bpet * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Pet Random dengan harga ${Bpet * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} pet random dengan harga ${Bpet * count} money`.trim(),
                  m,
                );
            ...
            case "limit":
              if (global.db.data.users[m.sender].money >= Blimit * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Limit dengan harga ${Blimit * count} money`,
                  m,
                );
              } else
                conn.reply(
            ...
            case "cupon":
              if (
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} cupon dengan harga ${Btiketcoin * count} Tiketcoin`,
                  m,
                );
              } else
                conn.reply(
            ...
            case "makananpet":
              if (global.db.data.users[m.sender].money >= Bmakananpet * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Makanan Pet dengan harga ${Bmakananpet * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} makanan pet dengan harga ${Bmakananpet * count} money`.trim(),
                  m,
                );
            ...
            case "makanannaga":
              if (
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Makanan Naga dengan harga ${Bmakanannaga * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} makanan naga dengan harga ${Bmakanannaga * count} money`.trim(),
                  m,
                );
            ...
            case "makananphonix":
              if (
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Makanan Phonix dengan harga ${Bmakananphonix * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} makanan phonix dengan harga ${Bmakananphonix * count} money`.trim(),
                  m,
                );
            ...
            case "makanankyubi":
              if (
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Makanan Kyubi dengan harga ${Bmakanankyubi * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} makanan kyubi dengan harga ${Bmakanankyubi * count} money`.trim(),
                  m,
                );
            ...
            case "makanangriffin":
              if (
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Makanan Griffin dengan harga ${Bmakanangriffin * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} makanan griffin dengan harga ${Bmakanangriffin * count} money`.trim(),
                  m,
                );
            ...
            case "makanancentaur":
              if (
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Makanan Centaur dengan harga ${Bmakanancentaur * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} makanan centaur dengan harga ${Bmakanancentaur * count} money`.trim(),
                  m,
                );
            ...
            case "tiketm":
              if (
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} TiketM dengan harga ${Bhealtmonster * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} tiketm dengan harga ${Bhealtmonster * count} money`.trim(),
                  m,
                );
            ...
            case "aqua":
              if (global.db.data.users[m.sender].money >= Baqua * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Aqua dengan harga ${Baqua * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} aqua dengan harga ${Baqua * count} money`.trim(),
                  m,
                );
            ...
            case "iron":
              if (global.db.data.users[m.sender].money >= Biron * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Iron dengan harga ${Biron * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} iron dengan harga ${Biron * count} money`.trim(),
                  m,
                );
            ...
            case "string":
              if (global.db.data.users[m.sender].money >= Bstring * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} String dengan harga ${Bstring * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} string dengan harga ${Bstring * count} money`.trim(),
                  m,
                );
            ...
            case "sword":
              if (global.db.data.users[m.sender].money >= Bsword * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Sword dengan harga ${Bsword * count} money`,
                  m,
                );
              } else
                conn.reply(
            ...
            case "batu":
              if (global.db.data.users[m.sender].money >= Bbatu * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Batu dengan harga ${Bbatu * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} batu dengan harga ${Bbatu * count} money`.trim(),
                  m,
                );
            ...
            case "umpan":
              if (global.db.data.users[m.sender].money >= Bumpan * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Umpan dengan harga ${Bumpan * count} money`,
                  m,
                );
              } else
                conn.reply(
            ...
            case "pancingan":
              if (global.db.data.users[m.sender].money >= Bpancingan * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Pancingan dengan harga ${Bpancingan * count} money`,
                  m,
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} pancingan dengan harga ${Bpancingan * count} money`.trim(),
                  m,
                );
          ...
          switch (_type) {
            case "potion":
              if (global.db.data.users[m.sender].potion >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} Potion dengan harga ${Spotion * count} money`.trim(),
                  m,
                );
            ...
            case "common":
              if (global.db.data.users[m.sender].common >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} Common Crate dengan harga ${Scommon * count} money`.trim(),
                  m,
                );
              } else
            ...
            case "uncommon":
              if (global.db.data.users[m.sender].uncommon >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} Uncommon Crate dengan harga ${Suncommon * count} money`.trim(),
                  m,
                );
              } else
            ...
            case "mythic":
              if (global.db.data.users[m.sender].mythic >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} Mythic Crate dengan harga ${Smythic * count} money`.trim(),
                  m,
                );
              } else
            ...
            case "legendary":
              if (global.db.data.users[m.sender].legendary >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} Legendary Crate dengan harga ${Slegendary * count} money`.trim(),
                  m,
                );
              } else
                conn.reply(
            ...
            case "sampah":
              if (global.db.data.users[m.sender].sampah >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} sampah, dan anda mendapatkan ${Ssampah * count} money`,
                  m,
                );
            ...
            case "kaleng":
              if (global.db.data.users[m.sender].kaleng >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} kaleng, dan anda mendapatkan ${Skaleng * count} money`,
                  m,
                );
            ...
            case "kardus":
              if (global.db.data.users[m.sender].kardus >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} kardus, dan anda mendapatkan ${Skardus * count} money`,
                  m,
                );
            ...
            case "botol":
              if (global.db.data.users[m.sender].botol >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} botol, dan anda mendapatkan ${Sbotol * count} money`,
                  m,
                );
            ...
            case "kayu":
              if (global.db.data.users[m.sender].kayu >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} kayu, dan anda mendapatkan ${Skayu * count} money`,
                  m,
                );
            ...
            case "pisang":
              if (global.db.data.users[m.sender].pisang >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} pisang, dan anda mendapatkan ${Spisang * count} money`,
                  m,
                );
            ...
            case "anggur":
              if (global.db.data.users[m.sender].anggur >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} anggur, dan anda mendapatkan ${Sanggur * count} money`,
                  m,
                );
            ...
            case "mangga":
              if (global.db.data.users[m.sender].mangga >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} mangga, dan anda mendapatkan ${Smangga * count} money`,
                  m,
                );
            ...
            case "jeruk":
              if (global.db.data.users[m.sender].jeruk >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} jeruk, dan anda mendapatkan ${Sjeruk * count} money`,
                  m,
                );
            ...
            case "apel":
              if (global.db.data.users[m.sender].apel >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} apel, dan anda mendapatkan ${Sapel * count} money`,
                  m,
                );
            ...
            case "berlian":
              if (global.db.data.users[m.sender].berlian >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} berlian, dan anda mendapatkan ${Sberlian * count} money`,
                  m,
                );
            ...
            case "emas":
              if (global.db.data.users[m.sender].emas >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} emas , dan anda mendapatkan ${Semasbiasa * count} money`,
                  m,
                );
            ...
            case "bensin":
              if (global.db.data.users[m.sender].bensin >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} bensin , dan anda mendapatkan ${SBensin * count} money`,
                  m,
                );
            ...
            case "weapon":
              if (global.db.data.users[m.sender].weapon >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} Weapon , dan anda mendapatkan ${SWeap * count} money`,
                  m,
                );
            ...
            case "pet":
              if (global.db.data.users[m.sender].pet >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} pet random, dan anda mendapatkan ${Spet * count} money`,
                  m,
                );
            ...
            case "makananpet":
              if (global.db.data.users[m.sender].makananpet >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} makanan pet, dan anda mendapatkan ${Smakananpet * count} money`,
                  m,
                );
            ...
            case "makanannaga":
              if (global.db.data.users[m.sender].makanannaga >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} makanan naga, dan anda mendapatkan ${Smakanannaga * count} money`,
                  m,
                );
            ...
            case "makanankyubi":
              if (global.db.data.users[m.sender].makanankyuni >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} makanan kyubi, dan anda mendapatkan ${Smakanankyubi * count} money`,
                  m,
                );
            ...
            case "aqua":
              if (global.db.data.users[m.sender].aqua >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} aqua, dan anda mendapatkan ${Saqua * count} money`,
                  m,
                );
            ...
            case "pancingan":
              if (global.db.data.users[m.sender].pancingan >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} pancingan, dan anda mendapatkan ${Spancingan * count} money`,
                  m,
                );
            ...
            case "iron":
              if (global.db.data.users[m.sender].iron >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} pancingan, dan anda mendapatkan ${Siron * count} money`,
                  m,
                );
            ...
            case "string":
              if (global.db.data.users[m.sender].string >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} string, dan anda mendapatkan ${Sstring * count} money`,
                  m,
                );
            ...
            case "sword":
              if (global.db.data.users[m.sender].sword >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} sword, dan anda mendapatkan ${Ssword * count} money`,
                  m,
                );
            ...
            case "batu":
              if (global.db.data.users[m.sender].batu >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} batu, dan anda mendapatkan ${Sbatu * count} money`,
                  m,
                );
            ...
            case "limit":
              if (global.db.data.users[m.sender].limit >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} limit, dan anda mendapatkan ${Slimit * count} money`,
                  m,
                );
            ...
            case "diamond":
              if (global.db.data.users[m.sender].diamond >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} Diamond, dan anda mendapatkan ${Sdiamond * count} money`,
                  m,
                );
      ...
      switch (type) {
        ...
        case "berlian":
          if (global.db.data.users[m.sender].money >= Bberlian * count) {
            ...
            conn.reply(
              m.chat,
              `Succes membeli ${count} Apel dengan harga ${Bberlian * count} money`,
              m,
            );
          } else
            conn.reply(
        ...
        case "makanannaga":
          if (global.db.data.users[m.sender].money >= Bmakanannaga * count) {
            ...
            conn.reply(
              m.chat,
              `Uang anda tidak cukup untuk membeli ${count} makanan pet dengan harga ${Bmakanannaga * count} money`.trim(),
              m,
            );
        ...
        case "makananphonix":
          if (global.db.data.users[m.sender].money >= Bmakananphonix * count) {
            ...
            conn.reply(
              m.chat,
              `Uang anda tidak cukup untuk membeli ${count} makanan pet dengan harga ${Bmakananphonix * count} money`.trim(),
              m,
            );
      ...
      switch (type) {
        ...
        case "sampah":
          if (global.db.data.users[m.sender].sampah >= count * 1) {
            ...
            conn.reply(
              m.chat,
              `Succes menjual ${count} sampah, dan anda mendapatkan ${Ssampah * count} money`.trim(),
              m,
            );
...
handler.help = ["shop", "toko"].map((v) => v + " (Ⓕ)");
handler.tags = ["rpg"];
