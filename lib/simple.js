  ...
  */
  exports.smsg = async (conn, m, hasParent) => {
    ...
    if (m.message) {
      ...
      m.myButton = m.isGroup && (m.type == 'interactiveResponseMessage' && m.message.interactiveResponseMessage.contextInfo.participant !== m.botNumber || m.type == 'templateButtonReplyMessage' && m.message.templateButtonReplyMessage.contextInfo.participant !== m.botNumber || m.type == 'listResponseMessage' && m.message.listResponseMessage.contextInfo.participant !== m.botNumber)
